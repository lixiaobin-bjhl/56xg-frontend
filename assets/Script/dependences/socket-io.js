...
1: [function(_dereq_, module, exports) {
	 ...
	 */
	  ...
	  function onTransportOpen() {
		  ...
		  let upgradeLosesBinary = !this.supportsBinary && self.transport.supportsBinary
	...
	*/
	 ...
	 */
            ...
            let XMLHttpRequest = _dereq_('xmlhttprequest-ssl')
	...
	JSONPPolling.prototype.doWrite = function (data, fn) {
	  ...
	  function initIframe() {
		  ...
		  let html = '<iframe src="javascript:0" name="' + self.iframeId + '">'
	...
	Request.prototype.create = function() {
	  let opts = { agent: this.agent, xdomain: this.xd, xscheme: this.xs, enablesXDR: this.enablesXDR }
	  ...
	  try {
		...
		try {
		  ...
		  if (!this.supportsBinary) {
			  ...
			  let ui8Arr = new Uint8Array(this.xhr.response)
			  var dataArray = []
			  for (let idx = 0, length = ui8Arr.length; idx < length; idx++) {
	 ...
	 */
	  ...
	  if (this.port && ((schema == 'https' && this.port != 443) ||
	  ...
	  for (let i = 0, l = total; i < l; i++) {
		  ...
		  parser.encodePacket(packet, self.supportsBinary, function(data) {
			  ...
			  if (self.perMessageDeflate) {
                                    let len = typeof data == 'string' ? global.Buffer.byteLength(data) : data.length
	...
	WS.prototype.uri = function() {
	  ...
	  // avoid port if default for schema
	  if (this.port && ((schema == 'wss' && this.port != 443)
	 ...
	 */
	  ...
	  exports.encode = function(arraybuffer) {
		...
		var i; var len = bytes.length; var 
base64 = '';
	  ...
	  exports.decode = function(base64) {
		...
		var encoded1; var encoded2; var encoded3; var 
encoded4
	 ...
	 */
            ...
            let BlobBuilder = global.BlobBuilder
	...
	var blobSupportsArrayBufferView = blobSupported && (function() {
	  try {
                    let b = new Blob([new Uint8Array([1, 2])])
		return b.size === 2
	  } catch (e) {
                    return false
	  }
...
len
	...
	exports.encodePacket = function (packet, supportsBinary, utf8encode, callback) {
	  ...
	  let data = (packet.data === undefined)
                    ? undefined
	  ...
	  let message = 'b' + exports.packets[packet.type] + packet.data.data
...
msg
	 ...
	 */
	  ...
	  function encodeOne(packet, doneCallback) {
		  ...
		  let len = (encoded instanceof ArrayBuffer)
                            ? encoded.byteLength
                            : encoded.size
		  ...
		  if (Blob) {
                            let blob = new Blob([binaryIdentifier.buffer, lengthAry.buffer, encoded])
	 ...
	 */
        function yeast() {
	  let now = encode(Number(new Date()))
	 ...
	 */
	  ...
	  let index = indexOf(this.connecting, socket)
...
sub.destroy()
	 ...
	 */
	  ...
	  let packet = { type: parserType, data: args }
	 ...
	 */
	  ...
	  function _reconstructPacket(data) {
		  ...
		  let buf = buffers[data.num] // appropriate buffer (should be natural order anyway)
		  return buf
		} else if (isArray(data)) {
		  for (let i = 0; i < data.length; i++) {
	  ...
	  function _removeBlobs(obj, curKey, containingObject) {
		...
		if ((global.Blob && obj instanceof Blob) ||
		  ...
		  for (let i = 0; i < obj.length; i++) {
                    ...
                    } else if (obj && typeof obj == 'object' && !isBuf(obj)) { // and object
		  for (let key in obj) {
	...
	(function () {
	  ...
	  var root = objectTypes[typeof window] && window || this;
		  var freeGlobal = freeExports && objectTypes[typeof module] && module && !module.nodeType && typeof global == 'object' && global
	  ...
	  function runInContext(context, exports) {
		...
		var Number = context['Number'] || root['Number'];
			...
			var SyntaxError = context["SyntaxError"] || root["SyntaxError"];
			var TypeError = context["TypeError"] || root["TypeError"];
			var Math = context["Math"] || root["Math"];
			var nativeJSON = context['JSON'] || root['JSON']
		...
		if (typeof nativeJSON == 'object' && nativeJSON) {
		  ...
		  exports.parse = nativeJSON.parse
			...
			var isProperty; var forEach; var 
undef
...
serialized = '{"a":[1,true,false,null,"\\u0000\\b\\n\\f\\r\\t"]}'
			...
			if (name == 'json-stringify') {
			  let stringify = exports.stringify; var 
stringifySupported = typeof stringify == 'function' && isExtended
		  ...
		  if (!isExtended) {
			...
			var getDay = function (year, month) {
			  return Months[month] + 365 * (year - 1970) + floor((year - 1969 + (month = Number(month > 1))) / 4) - floor((year - 1901 + month) / 100) + floor((year - 1601 + month) / 400)
			};
		  }
...
constructor
			  if ((members.__proto__ = null, members.__proto__ = {
				  ...
				  let original = this.__proto__; var 
result = property in (this.__proto__ = null, this)
		  ...
		  forEach = function (object, callback) {
                            let size = 0; var Properties; var members; var 
property;
			...
			if (!size) {
			  ...
			  // properties.
			  forEach = function (object, callback) {
                                    let isFunction = getClass.call(object) == functionClass; var property; var 
length
			  ...
			  forEach = function (object, callback) {
                                    ...
                                    let members = {}; var isFunction = getClass.call(object) == functionClass; var 
property
				for (property in object) {
...
isConstructor
		  ...
		  if (!has('json-stringify')) {
			...
			var leadingZeroes = '000000';
			  ...
			  let result = '"'; var index = 0; var length = value.length; var 
useCharIndex = !charIndexBuggy || length > 10
			  ...
			  let value; var className; var year; var month; var date; var time; var hours; var minutes; var seconds; var milliseconds; var results; var element; var index; var length; var prefix; var 
result
			  try {
			  ...
			  if (typeof value == 'object') {
				...
				if (className == arrayClass) {
				  ...
				  forEach(properties || value, function (property) {
                                            let element = serialize(property, value, callback, properties, whitespace, indentation, stack)
					if (element !== undef) {
			...
			exports.stringify = function (source, filter, width) {
			  let whitespace; var callback; var properties; var 
className
...
Source
			...
			var abort = function () {
			  ...
			  throw SyntaxError()
                            ...
                            let lex = function () {
			  let source = Source; var length = source.length; var value; var begin; var position; var isSigned; var 
charCode
			  while (Index < length) {
				...
				switch (charCode) {
				  ...
				  default:
					...
					if (charCode == 45) {
					  ...
					  return Number(source.slice(begin, Index));
                                            }
